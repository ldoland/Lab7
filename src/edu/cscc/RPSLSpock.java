 ...
 * @author Laura Doland
 * October 15, 2020
 * RPSLSPock class for Rock, Paper, Scissors, Lizard, Spock methods
 * Version 1.0
 */
...
public class RPSLSpock {
    ...
    /**
     * Constructor
     * @param pick - the value the user chooses and checks to make sure it is valid.
     * @return pick - return the value the user chose in all uppercase
     */
    ...
    /**
     * Method generates a random pick from the computer
     * @return the computer's pick in all uppercase
     */
    ...
    /**
     * method determines if the c_pick(the computer) or h_pick(user) won
     * @param c_pick - the computer generated pick
